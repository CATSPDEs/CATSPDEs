...
class CRSMatrix : public AbstractSparseMatrix<double>, public IRealMatrix { // matrix is stored in comressed row storage format (http://netlib.org/linalg/html_templates/node91.html)
