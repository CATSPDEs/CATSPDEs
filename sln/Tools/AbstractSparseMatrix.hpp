...
public:
	virtual istream& loadSparse(istream& from = cin) = 0; // construct matrix from stdin (sparse form)
	virtual ostream& saveSparse(ostream& to   = cout) const = 0; // save matrix to stdout (sparse form)
