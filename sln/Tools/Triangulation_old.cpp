...
//		adjList[elementNodesIndicies[0]].insert(elementNodesIndicies[1]);
//		adjList[elementNodesIndicies[0]].insert(elementNodesIndicies[2]);
//		adjList[elementNodesIndicies[1]].insert(elementNodesIndicies[2]);
//	}
//	return adjList;
//}
//
...
//}
//
//RibsNumeration Triangulation::computeRibsNumeration(Index* numbOfRibs, Index* numbOfBndryRibs) {
//	RibsNumeration res(_triangles.size());
//	Index currentRibNumber = 0, bndryRibs = 0, n;
//	LocalIndex k;
//	for (Index i = 0; i < _triangles.size(); ++i)
...
//			}
//		}
//	if (numbOfRibs) *numbOfRibs = currentRibNumber;
//	if (numbOfBndryRibs) *numbOfBndryRibs = bndryRibs;
//	return res;
//}
//
